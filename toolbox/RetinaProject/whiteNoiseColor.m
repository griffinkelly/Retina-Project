...
try
    ...
    while count < 100
        ...
        for i=1:numRects
            ...
            %sets size of pixels and rate of update
            noiseimg=(50*randn(1500, 1500) + 128);
            ...
            %last bracket changes color filtering
            Screen('DrawTexture', win, tex, [], dstRect(i,:), [], 0, 1, [128 255 0]);
