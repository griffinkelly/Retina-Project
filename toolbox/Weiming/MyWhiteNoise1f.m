...
function MyWhiteNoise1f(numRects, rectSize, scale, syncToVBL, dontclear)
...
% Number "1": delay pattern drawing by 1 frame at default screen refreshrate;
% Number "0": increase pattern drawing rate by 1 frame at default screen refreshrate;
