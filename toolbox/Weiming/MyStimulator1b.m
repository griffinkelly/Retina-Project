function MyStimulator(angle, cyclespersecond, freq, gratingsize, internalRotation)
% function MyStimulator([angle=0][, cyclespersecond=1][, freq=1/360][, gratingsize=2400][, internalRotation=0])
